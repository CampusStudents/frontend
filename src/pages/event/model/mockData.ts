...
export const eventDetails: EventDetails = {
    ...
    month: "ноя",
    day: "11",
    dateLabel: "Понедельник, 11 ноября",
    timeLabel: "10:00 - 11:00",
    locationName: "Belova Art Gallery",
    address: "Казань, Кремлевская, 9 А",
    organizerLabel: "Организатор события",
    organizerName: "Т-Банк",
    ...
    primaryActionLabel: "Собрать команду",
    secondaryActionLabel: "Подписаться",
    gallery: [
